    ...
    return {
        ...
        mergeData(json, arr) {
            ...
            json.features.forEach(function(obj) {
                const o = cn.find(src => {
                    return (
                        getPath.call(obj, id[0]) === getPath.call(src, id[1])
                    );
                });
                if (o) {
        ...
        setColorcountries(colorId, selector = 'body', format = '.1f') {
            ...
            const colorCountries = d3
                .select(selector)
                .append('div')
                .attr('class', 'color-countries');
            ...
            colorCountries
                .selectAll('div.color-countries-item')
                .data(colorList)
                .enter()
                .append('div')
                ...
                .attr('class', d => {
                    const selected =
                        d.properties.cid === _.cid ? 'selected' : '';
        ...
        setColorRange(selector = 'body', format = '.1f') {
            ...
            _.colorItems = colorRange
                .selectAll('div.color-range-item')
                .data(colorList)
                .enter()
                .append('div')
                .attr('class', d => `color-range-item s-${d.id}`)
